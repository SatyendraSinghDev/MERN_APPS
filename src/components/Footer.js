            ...
            <div className="col-4">
              ...
              <div>
                <address className="text-white fs-6">
                  Hno : 34 Shambhu Palace <br /> Agra, U.P. <br />
                  PinCode: 282001
                </address>
                <a
                  href="tel:+91 8077476017"
                  className="mt-3 d-block mb-1 text-white"
                >
                  +91 8077476017
                </a>
                <a
                  href="mailto:satyendrasinghdev2@gmail.com"
          ...
          <div className="row">
            <div className="col-12">
              <p className="text-center mb-0 text-white">
                &copy; {new Date().getFullYear()}, Powered by Developer's Satty
                Marketify
              </p>
            </div>
          </div>
